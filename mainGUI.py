...
aEntryTabFive_1 = tk.Entry(tab1, state='disabled', value=100)
...
aEntryTabFive_2 = tk.Entry(tab1, state='disabled', value=42)
...
seventhEntryTabFive_1 = tk.Entry(tab1, state='disabled', value=100)
...
seventhEntryTabFive_2 = tk.Entry(tab1, state='disabled', value=50)
...
seventhEntryTabFive_3 = tk.Entry(tab1,state='disabled', value=0.5)
...
seventhEntryTabFive_4 = tk.Entry(tab1, state='disabled', value=42)
